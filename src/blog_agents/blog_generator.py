...
from .topic_recommendation import topic_recommendation_agent

BLOG_CREATOR_PROMPT = """
    Given the following information, generate a blog post.
    Use UK English.
    Write a full blog post that will rank for the topic asked by the user.                 
...
blog_generator_agent = Agent("Blog Generator Agent", model="gpt-4o", instructions=BLOG_CREATOR_PROMPT, handoffs=[topic_recommendation_agent])